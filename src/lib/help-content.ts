...
export const videos: VideoItem[] = [
  ...
  },
  {
    ...
    topic: "Payments Admin Dashboard",
    topicSlug: "payments-admin",
    product: "Borna Admin",
  ...
  {
    id: "KKuQlei7FRk",
    title: "How to Create Patient Payment Requests in Borna Care | Step-by-Step Admin Payments Demo",
    topic: "Payments Admin Dashboard",
    topicSlug: "payments-admin",
    product: "Borna Admin",
    youtubeId: "KKuQlei7FRk",
    description: "Create a payment request, add a guest patient, and send a secure payment link by email and SMS.",
  },
  {
    id: "nRGY1-LxXaM",
    title: "How to Sign Up and Securely Sign In to the Borna Admin Workspace",
    topic: "Getting Started",
    topicSlug: "getting-started",
    product: "Borna Admin",
    youtubeId: "nRGY1-LxXaM",
    description: "Create an admin account, sign in, and complete two-factor authentication.",
  },
  {
    id: "cSqDysdJ7b0",
    title: "Borna Connect Call Logs: AI Summaries, Recordings & Follow-Ups",
    topic: "Call Logs & AI Summaries",
    topicSlug: "call-logs",
    product: "Borna Connect",
    youtubeId: "cSqDysdJ7b0",
    description: "Review AI-handled calls, summaries, recordings, transcripts, and follow-up actions.",
  },
  {
    id: "P-qbDvW8Acg",
    title: "Borna Connect Chat, Archived Chat, & Follow-Ups | Step-by-Step Demo",
    topic: "Connect Chat, Archived Chats & Follow-Ups",
    topicSlug: "connect-chat",
    product: "Borna Connect",
    youtubeId: "P-qbDvW8Acg",
    description: "Review patient chats, take over conversations, archive chats, and manage follow-ups.",
  },
  {
    id: "LBJwFm4sYYw",
